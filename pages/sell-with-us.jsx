...
function SellWithUs() {
  ...
  const [nombre_representante_entidad, setNombreRepresentanteEntidad] = useState('')
  ...
  useEffect(() => {
    ...
    setCalculate(maximum ? maximum.getAttribute('maxlength') - maximum.value.length : calculate)
        ...
        >
          ...
          <label className="col-span-full xl:col-span-1 lg:col-span-1 md:col-span-1">
            ...
            <PhoneInput
              ...
              inputClass={'bg-gray-300 text-gray-900 mt-2 rounded-lg ring-offset-1 ring-offset-dm-blue ring-dm-blue focus:outline-none select-none focus:ring-1'}
              specialLabel={''}
              country={'cu'}
