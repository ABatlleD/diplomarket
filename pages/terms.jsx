    ...
    <>
     ...
     <div className='flex flex-col my-8 mx-4 lg:mx-40'>
        <div className='flex flex-col mb-8 text-footer-background-300'>
          <h1 className='font-bold text-[2rem] text-footer-background-300 mb-4'>{t('terms.sections.1.title')}</h1>
          <p className='text-xl text-justify'>{t('terms.sections.1.text')}</p>
        </div>
        <div className='flex flex-col mb-8 text-footer-background-300'>
          <h1 className='font-bold text-[2rem] text-footer-background-300 mb-4'>{t('terms.sections.2.title')}</h1>
        ...
        <div className='flex flex-col mb-8 text-footer-background-300'>
          <h1 className='font-bold text-[2rem] text-footer-background-300 mb-4'>{t('terms.sections.3.title')}</h1>
        ...
        <div className='flex flex-col mb-8 text-footer-background-300'>
          <h1 className='font-bold text-[2rem] text-footer-background-300 mb-4'>{t('terms.sections.4.title')}</h1>
          <p className='text-xl text-justify'>{t('terms.sections.4.text.1')}</p>
          <p className='text-xl text-justify'>{t('terms.sections.4.text.2')}</p>
        </div>
        <div className='flex flex-col mb-8 text-footer-background-300'>
          <h1 className='font-bold text-[2rem] text-footer-background-300 mb-4'>{t('terms.sections.5.title')}</h1>
          <p className='text-xl text-justify'>{t('terms.sections.5.text')}</p>
        </div>
        <div className='flex text-footer-background-300 flex-col mb-8'>
          <h1 className='font-bold text-[2rem] text-footer-background-300 mb-4'>{t('terms.sections.6.title')}</h1>
        ...
        <div className='flex text-footer-background-300 flex-col mb-8'>
          <h1 className='font-bold text-[2rem] text-footer-background-300 mb-4'>{t('terms.sections.7.title')}</h1>
