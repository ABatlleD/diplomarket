...
const TimerLoadingIcon = () => (
  <svg version="1.1" id="L2" xmlns="http://www.w3.org/2000/svg" className="w-8" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 100" enableBackground="new 0 0 100 100" xmlSpace="preserve">
    <circle fill="none" stroke="#fff" strokeWidth="4" strokeMiterlimit="10" cx="50" cy="50" r="48"></circle>
...
export default TimerLoadingIcon
